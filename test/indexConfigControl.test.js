...
describe('Routes', function () {
  describe('GET /admin/indexConfigCompontent', function () {
    ...
    it('GET /admin/indexConfigCompontent', function (done) {
    ...
    it('Post /indexConfigCompontent/add', function (done) {
      request()     
    ...
    it('Post /indexConfigCompontent', function (done) {
      request()     
      .post('/indexConfigCompontent')
      .send({
        inputOne: 'data1',
    ...
    it('Delete /admin/indexConfigCompontent/delete', function (done) {
