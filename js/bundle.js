...
module.exports = React.createClass({displayName: "exports",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "bannerContent-background"}, 
        React.createElement("div", {className: "bannerContent-position"}, 
          React.createElement("span", {className: "bannerContent-title"},  this.props.bannerContent.title), 
          React.createElement("span", {className: "bannerContent-content"},  this.props.bannerContent.content)
        )
      )
    );
  }
...
$.get('/show?ajax=true', function (data) {
  console.log(data);
    ...
    React.render(React.createElement(ContentMain, {
...
//React.render(<ContentMain />, document.getElementById('content'));

},{"./show.js":159,"react":156}],159:[function(require,module,exports){
var React = require('react');
  ...
  render: function   () {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(SlideBar, {slideList:  this.props.slideList, contentInfo:  this.props.contentInfo})
      )
    );
  }
})
},{"../common/frontBanner/banner.js":157,"./slideBar.js":161,"react":156}],160:[function(require,module,exports){
var React = require('react');
...
module.exports = React.createClass({displayName: "exports",
  ...
  createContent: function(arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
      if (arr[i].sort == this.props.title) {
        content.push(
          React.createElement("div", {className: "showContent-example"}, 
            React.createElement("div", {style: { border: '2px solid #dedede', width: '75%'}}, 
              React.createElement("img", {src:  this.state.url + arr[i].imgSrc, style: { width: '98%', margin: '1%'}})
            ), 
            React.createElement("div", null, 
              React.createElement("span", {className: "showContent-font"}, 
              
                 arr[i].content ? React.createElement("div", {style: {'padding': '13px'}},  arr[i].content) : null
  ...
  render: function() {
    var that = this;
    return (
      React.createElement("div", {className: "showContent-content"}, 
        React.createElement("span", {className: "showContent-title"},  that.props.title), 
...
module.exports = React.createClass({displayName: "exports",
  ...
  createlist: function(arr) {
    var list = [];
    for (var i = 0; i < arr.length; i++){
      list.push(React.createElement("li", null,  arr[i] ));
    }
    return list;
  },
  ...
  createSlidePills: function(arr) {
    ...
    arr.forEach(function (item) {
        //生成做导航栏
      slidePills.push(
        React.createElement("div", {className: "slideBar-sortPosition"}, 
          React.createElement("div", {className: "slideBar-slideSort"}, 
            React.createElement("span", null,  item.slideSort)
          ), 
          React.createElement("ul", {className: "slideBar-list", onClick:  that.handlerClick}, 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement("div", {className: "slideBar-position"},  that.createSlidePills( that.props.slideList) ), 
        React.createElement(ShowContent, {contentInfo:  that.props.contentInfo, title:  that.state.title})
      )
    );
  }
})

},{"./showContent.js":160,"react":156}]},{},[158]);
